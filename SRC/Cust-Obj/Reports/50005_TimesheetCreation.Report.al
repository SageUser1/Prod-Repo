report 50005 "Create Time Sheets - 15 Days"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Create Time Sheets - 15 Days';
    ProcessingOnly = true;
    UsageCategory = Tasks;
            ...
            dataitem(Resource; Resource)
            {
                ...
                begin
                    ...
                    if CheckExistingPeriods() then begin
                        ...
                        TimeSheetHeader.Description := Format(StartingDate) + '..' + Format(EndingDate);//PK
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(EndingDate; EndingDate)//PK
                    {
                        ApplicationArea = Jobs;
                        Caption = 'Ending Date';
                        ToolTip = 'Specifies the end date of the time sheet.';
                    }
                    field(NoOfPeriods; NoOfPeriods)
                    {
                        ApplicationArea = Jobs;
                        Caption = 'No. of 15 Days';
                        MinValue = 1;
                        Visible = false;
    ...
    var
        ...
        Errortxt001: Label 'Difference between start and end date should not be graeter than 16 days.';
    begin
        CheckUserSetup();
        ...
        if EndingDate - StartingDate > 16 then
            Error(Errortxt001);
