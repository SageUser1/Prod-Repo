report 50001 "Purchase Orde SubCOn - CompQ"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultRenderingLayout = RDLC;
    Caption = 'Purchase Orde SubCon- CompQ';
            ...
            begin
                ...
                IF VendLrec.GET("Buy-from Vendor No.") then
                    IF VendTypeLrec.GET(VendLrec."Vendor Type") then begin
                        IF Not VendTypeLrec."Sub-Con Vendor" then
                            CurrReport.Skip();
                    end else
                        CurrReport.Skip();
            end;
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './SRC/Cust-Obj/Reports/Layout/PurchaseOrderCompQSubCon.rdl';
        }
    }

    var
        CompInfo: Record "Company Information";
        ReportCaptlbl: Label 'Subcontractor Agreement Purchase Order: ';
