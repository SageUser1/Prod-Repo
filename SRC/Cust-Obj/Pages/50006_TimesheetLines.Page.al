page 50006 "Time Sheet Lines - 15D"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    layout
    {
        area(Content)
        {
            repeater(Control1)
            {
                ...
                field(TimesheetHeader2ResNo; TimesheetHeader2."Resource No.")
                {
                    ApplicationArea = all;
                    Caption = 'Resource No.';
                    Editable = false;
                }
                field(TimesheetHeader2ResName; TimesheetHeader2."Resource Name")
                {
                    ApplicationArea = all;
                    Caption = 'Reource Name';
                    Editable = false;
                }
    ...
    begin
        ...
        IF TimesheetHeader2.GET(rec."Time Sheet No.") Then
            TimesheetHeader2.CalcFields("Resource Name");
    ...
    begin
        ...
        if TimeSheetLine.FindSet() then
            ...
            //TimeSheetApprovalMgt.NoTimeSheetLinesToProcess(TimeSheetAction);//PK
        end;
    ...
    var
        ...
        TimesheetHeader2: Record "Time Sheet Header";
